...
**Source**: M2a — Tenancy Foundation Core (proposal: `2026-07-22-m2a-tenancy-core`); M2b — Invitations (proposal: `m2b-invitations`); M2c — Move member + workspace history (proposal: `m2c-move-history`)
