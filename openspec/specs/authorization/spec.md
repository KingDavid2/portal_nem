...
**Source**: M2a — Tenancy Foundation Core (proposal: `2026-07-22-m2a-tenancy-core`); M2c — Move member + workspace history (proposal: `m2c-move-history`); M3 — School Structure (proposal: `m3-school-structure`); Quizzy P4 — MCP server (proposal: `quizzy-p4-mcp-server`)
